...
public class PIDController implements Sendable {
  ...
  public PIDController(
      double p, double i, double d, double deadband, double velDeadband, double max) {
    this.kP = p;
    this.kI = i;
    this.kD = d;
  ...
  public double updateOutput(double pos) {
    ...
    if (prevError == Double.MAX_VALUE) prevError = error;
  ...
  /**
   * Checks whether this PIDController is active by testing whether it was updated during the
   * previous frame.
   */
